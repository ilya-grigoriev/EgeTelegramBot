...
from parse_data.format.format_data_in_tag import format_table_in_html, \
    format_answer_from_tag, delete_excess_data_in_tag


async def get_answer_task(*, template_url: str, html_code: str,
